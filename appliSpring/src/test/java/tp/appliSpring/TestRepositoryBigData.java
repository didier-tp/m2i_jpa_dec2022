...
import tp.appliSpring.repository.RepositoryBigData;
...
class TestRepositoryBigData {
	...
	void testInsertionEtRelecture() {
		try {
			String imageFilePath ="clementine.jpeg";//to read from filesustem and store in database
			String imageFilePath2 ="clementine2.jpeg";//to read from database and write in filesystem
			String jsonFilePath ="product.json";//to read from filesustem and store in database
